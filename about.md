...
My name is Will, and I am a rising junior at Yale University broadly interested in the intersection of language and computation. I'm also quite into historical linguistics and philology, with a particular focus on medieval Germanic languages. Along with these interests of mine comes a fundamental appreciation for deep learning, and over the past two years I have been tinkering with neural models for language tasks, video game agents, and other random stuff (all the cool kids are doing it ¯\\_(ツ)_/¯).
